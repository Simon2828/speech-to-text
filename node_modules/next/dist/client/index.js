...
const { props, err, page, query, buildId, assetPrefix, runtimeConfig, dynamicIds } = data;
...
export async function render(props) {
    ...
    try {
        ...
        await renderError(Object.assign({}, props, { err }));
    }
}
...
export async function renderError(props) {
    ...
    await doRender(Object.assign({}, props, { err, Component: ErrorComponent, props: initProps }));
}
...
async function doRender({ App, Component, props, err, emitter: emitterProp = emitter }) {
    ...
    const appProps = Object.assign({ Component, err, router, headManager }, props);
    // lastAppProps has to be set before ReactDom.render to account for ReactDom throwing an error.
    lastAppProps = appProps;
    emitterProp.emit('before-reactdom-render', { Component, ErrorComponent, appProps });
    // In development runtime errors are caught by react-error-overlay.
    if (process.env.NODE_ENV === 'development') {
        renderReactElement((React.createElement(App, Object.assign({}, appProps))), appContainer);
    }
    else {
        ...
        renderReactElement((React.createElement(ErrorBoundary, { onError: onError },
            React.createElement(App, Object.assign({}, appProps)))), appContainer);
    }
